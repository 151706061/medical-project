...
public class WebCommonController extends WebBaseController{
	...
	public ModelAndView home(HttpSession session){
		...
		if( user == null ){
			...
			return new ModelAndView("redirect:/modules/web/user/main.jsp?userType=" + user.getUserType() + "#requests");
			...
			return new ModelAndView("redirect:/modules/web/juniordoctor/main.jsp?userType=" + user.getUserType() + "#requests");
		}else if( user.getUserType().equals( Constants.USER_TYPE_SENIOR_DOCTOR) ){
			return new ModelAndView("redirect:/modules/web/seniordoctor/main.jsp?userType=" + user.getUserType() + "#requests");
		}
		else if( user.getUserType().equals( Constants.USER_TYPE_SECRETARY) ){
			return new ModelAndView("redirect:/modules/web/secretary/main.jsp?userType=" + user.getUserType() + "#requests");
