    ...
    <div class="box">
        <div class="row row-offcanvas row-offcanvas-left">
            ...
            <div class="column col-sm-2 col-xs-1 sidebar-offcanvas" id="sidebar">
               ...
               <div class="column-sm-12 userinfo-col">
               		<div class="userinfo">
                ...
                <ul class="nav hidden-xs" id="lg-menu">
                    <li><a href="#stories"><i class="glyphicon glyphicon-open"></i> 我的请求</a></li>
                    <li><a href="#featured"><i class="glyphicon glyphicon-yen"></i> 预存诊费</a></li>
