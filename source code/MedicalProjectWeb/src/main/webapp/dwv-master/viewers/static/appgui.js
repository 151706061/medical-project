...
dwv.gui.Toolbox = function (app)
{
    ...
    this.setup = function(list)
    {
        ...
        var toolbox = document.getElementById("btn_tool");
        toolbox.onclick = function() { toggle("#toolbox"); };
    
        var history = document.getElementById("btn_history");
       
        history.onclick = function() { toggle("#history"); };
    
        var tags = document.getElementById("btn_tag");
       
        tags.onclick = function() { toggle("#tags"); };
    
        var image = document.getElementById("btn_image");
        ...
        var help = document.getElementById("btn_help");
